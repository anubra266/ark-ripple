...
describe('Accordion', () => {
	...
	it('should lazy mount an accordion item', async () => {
		render(ComponentUnderTest, { lazyMount: true, collapsible: true });
	...
	it('should lazy mount and unmount on exit an accordion item', async () => {
		render(ComponentUnderTest, { lazyMount: true, unmountOnExit: true, collapsible: true });
