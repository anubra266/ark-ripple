...
import { ComponentUnderTest, RatingGroupWithField } from './basic.ripple';
...
describe('Rating Group', () => {
  ...
  it('should trigger onValueChange on click', async () => {
    ...
    render(ComponentUnderTest, { value: 1, onValueChange, count: 5 });
...
describe('Rating Group / Field', () => {
  ...
  it('should display error text when error is present', async () => {
    render(RatingGroupWithField, { invalid: true });
