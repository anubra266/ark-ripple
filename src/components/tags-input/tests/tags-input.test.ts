...
import { ComponentUnderTest, TagsInputWithField } from './basic.ripple';
...
describe('TagsInput', () => {
  ...
  it('should clear all items when clear all button is clicked', async () => {
    render(ComponentUnderTest);
...
describe('TagsInput / Field', () => {
  ...
  it('should display error text when error is present', async () => {
    render(TagsInputWithField, { invalid: true });
