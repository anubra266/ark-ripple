...
id: styling
title: Styling
description: Learn how to style Ark Ripplw components.
---

## Overview

Ark Ripple is a headless component library that works with any styling solution. It provides functional styles for elements
...
> classes to Ark Ripple components.
