...
id: animation
title: Animation
description: Animate your Ark Ripple Components with CSS keyframes or your favorite JavaScript animation library.
---

Adding animation to Ark Ripple Components is as straightforward as with any other component, but keep in mind some
...
phases with CSS. The latter is achievable because Ark Ripple Components postpones the unmounting while your animation runs.
...
There's plenty of versatility when it comes to animating your Ark Ripple Elements with JavaScript libraries. Various
libraries such as GreenSock, anime.js, Framer Motion, and more can add a new level of interaction and feedback to your
UI components.

One significant advantage of using Ark Ripple Elements is the control you have over the unmounting phase of your components.
