...
description: Working with tree collections in Ark Ripple
---
...
```ts
import { createTreeCollection } from 'ark-ripple/collection'
...
```ts
import { createFileTreeCollection } from 'ark-ripple/collection'
